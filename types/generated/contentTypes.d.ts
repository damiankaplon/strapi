...
export interface ApiRealizacjaRealizacja extends Struct.CollectionTypeSchema {
  collectionName: 'realizacje';
  info: {
    displayName: 'Realizacje';
    pluralName: 'realizacje';
  ...
  attributes: {
    ...
    Kategoria: Schema.Attribute.String;
    Konstrukcja: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
